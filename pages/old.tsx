  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content={`AI-powered search and chat trained on Alison Blog.`}
        />
        <meta
          name="viewport"
        ...
        <div className="flex-grow overflow-auto">
          <div className="mx-auto flex h-full w-full max-w-[750px] flex-col items-center px-3 pt-4 sm:pt-8">
            ...
            {loading ? (
              ...
              <div className="mt-6 text-center text-lg">{`AI-powered search & chat for Alison Blog.`}</div>
            )}
          </div>
        </div>
        <div className="absolute bottom-0 right-0">
        <img src="https://i.ibb.co/HrnFH32/ai.png" alt="Alison" />
				</div>
