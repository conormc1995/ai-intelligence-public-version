export default function Settings(
  { mode, setMode, matchCount, setMatchCount, apiKey, setApiKey, setShowSettings, handleSave, handleClear }
   : { mode:"search" | "chat", setMode:Function, matchCount:number, setMatchCount:Function, apiKey:string, setApiKey:Function, setShowSettings:Function, handleSave:Function, handleClear:Function }
) {
  return (
